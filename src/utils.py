...
def decode_token_pickle():
    """token.pickle dosyasını GitHub Secrets'ten al."""
    import os
    import base64
    from src.config import Config
    ...
    if not token_pickle_b64:
        return None  # token.pickle yoksa None döndür
    ...
    try:
        ...
        print(f"⚠️ token.pickle decode hatası: {str(e)}")
        return None
