...
def create_text_image(text: str, width: int, height: int, font_size: int = 420, color: str = "white") -> Image.Image:
...
def create_shorts_video(audio_path: str, script: str, output_path: str):
    ...
    for line in lines:
        ...
        text_img = create_text_image(line, width, height, font_size=420, color="white")
