...
def decode_youtube_credentials():
    ...
    # Eski secret ismiyle uyumlu hale getir
    ...
    try:
        # Base64 decode et
        json_data = base64.b64decode(encoded_credentials).decode("utf-8")
        credentials = json.loads(json_data)
        
        # client_secret.json olarak kaydet
        client_secret_path = Config.TEMP_DIR / "client_secret.json"
        with open(client_secret_path, "w") as f:
            json.dump(credentials, f)
        
        logger.info("✅ YouTube kimlik bilgileri başarıyla decode edildi.")
